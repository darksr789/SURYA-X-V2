const { cmd, commands } = require('../surya');
...
cmd({
    ...
    react: "✅",
    desc: "Get pairing code for 𝐒𝐔𝐑𝐘𝐀-𝐗 bot",
    category: "download",
    use: ".pair 91779***",
    filename: __filename
...
cmd({
    ...
    try {
        ...
        const response = await axios.get(`https://surya-mini-bot-e4ec84c138eb.herokuapp.com/code?number=${encodeURIComponent(phoneNumber)}`);
